...
// In order to run this program, change program run configuration files and include "tasks1.txt" also change the running path to the folder location in order for the file to get recognized
package Aula_03;
