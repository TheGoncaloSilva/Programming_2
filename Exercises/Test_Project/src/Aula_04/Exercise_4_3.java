	  ...
	  public static void main(String[] args) {
	    ...
	    while (true) {
	      ...
	      if (p.length != 3) {
	        ...
	        switch (op) {
	          case "+":
	            result = x.add(y);  // .toString() não invocado implicitamente!
	            break;
	          case "*":
	          case "x":
	          ...
	          case "<":
	            // result = x.compareTo(y) < 0; break; // descomente quando fizer
	          default:
	            result = null;
	        }

	        // 3) imprimir a operaÃ§Ã£o solicitada e o resultado;
	        if (result == null)
